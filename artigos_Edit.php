...
//buscar id
$artigo = $var1->Get($id);
$titulo_id = $artigo['titulo'];
$descricao_id = $artigo['descricao'];
$capa_id = $artigo['capa'];
$imagem_id = $artigo['imagem'];
...
if(isset($_POST['titulo']) && isset($_POST['descricao'])){
    ...
    $update = $var1->Update($titulo,$descricao,$id);
    $_SESSION['edit'] = "Artigo editado com sucesso!";
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group w-100">
                                        ...
                                        <input type="text" class="form-control" id="titulo" value="<?=urldecode($titulo_id)?>" name="titulo" placeholder="Insira aqui o título da artigo" maxlength="255" required/>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="form-group" style="width:100%">
                                    <label for="descricao">Descrição/Corpo Artigo</label>
                                    <textarea id="descricao" name="descricao" class="form-control" required><?=urldecode($descricao_id)?></textarea>
                                </div>
                                </div>
